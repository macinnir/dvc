...
func (ss *Sqlite) Connect() (server *schema.Server, e error) {
	...
	server.Connection, e = sql.Open("sqlite3", "./"+ss.config.Name+".db")
	return
}
...
func (ss *Sqlite) FetchDatabases(server *schema.Server) (databases map[string]*schema.Database, e error) {
	...
	// 	databases[databaseName] = &schema.Schema{Name: databaseName, Host: server.Host}
	// }
...
func (ss *Sqlite) createTableChangeSQL(localTable *schema.Table, remoteTable *schema.Table) (sql string, e error) {
...
func (ss *Sqlite) createTable(table *schema.Table) (sql string, e error) {
...
func (ss *Sqlite) dropTable(table *schema.Table) (sql string, e error) {
	sql = fmt.Sprintf("DROP TABLE \"%s\";", table.Name)
	return
}

func (ss *Sqlite) translateColumnType(column *schema.Column) (sqlType string) {
...
func (ss *Sqlite) createColumn(column *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) alterTableDropColumn(table *schema.Table, column *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) changeColumn(table *schema.Table, localColumn *schema.Column, remoteColumn *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) alterTableCreateColumn(table *schema.Table, column *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) addIndex(table *schema.Table, column *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) addUniqueIndex(table *schema.Table, column *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) dropIndex(table *schema.Table, column *schema.Column) (sql string, e error) {
...
func (ss *Sqlite) dropUniqueIndex(table *schema.Table, column *schema.Column) (sql string, e error) {
