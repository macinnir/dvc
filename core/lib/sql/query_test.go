...
func TestCreateColumn(t *testing.T) {
	...
	// int
	column := &schema.Column{Name: "Foo", IsNullable: false, DataType: "int", Type: "int(10) unsigned", Extra: "auto_increment"}
...
func TestAlterTableCreateColumn(t *testing.T) {
	...
	table := &schema.Table{Name: "Foo"}
	column := &schema.Column{Name: "Bar", IsNullable: false, DataType: "int", Type: "int(10) unsigned", Extra: "auto_increment"}
	q := &Query{}
