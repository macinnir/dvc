...
func (c *Job) Create(db query.DBInterface) error {
	return nil
}

func (c *Job) Update(db query.DBInterface) error {
	return nil
}

func (c *Job) Delete(db query.DBInterface) error {
	return nil
}

func (c *Job) FromID(db query.DBInterface, id int64) (query.IModel, error) {
	return nil, nil
}
